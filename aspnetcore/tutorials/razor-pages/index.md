...
In dieser Reihe werden die Grundlagen der Erstellung einer Razor-Pages-Web-App mit ASP.NET Core mithilfe von Visual Studio erläutert. Erklärungen zur Mac-Version finden Sie [hier](xref:tutorials/razor-pages-mac/index). Erklärungen zur Visual Studio Code-Version finden Sie [hier](xref:tutorials/razor-pages-vsc/index).
