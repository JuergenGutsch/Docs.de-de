...
## [Erstellen einer Razor-Pages-Web-App](xref:tutorials/razor-pages/index)
...
## [Datenzugriff: Razor-Pages mit EF Core](xref:data/index)
...
## [Abhängigkeitsinjektion (Services)](fundamentals/dependency-injection.md)
...
## [Auswählen zwischen der .NET Core- und der .NET Framework-Runtime](/dotnet/articles/standard/choosing-core-framework-server)
...
#### [Development-time IIS support in Visual Studio for ASP.NET Core (IIS-Support zum Zeitpunkt der Entwicklung in Visual Studio für ASP.NET Core)](xref:publishing/development-time-iis-support)
...
#### [Visual Studio-Tools für Docker](xref:publishing/vs-tools-for-docker)
...
## [Bereitstellung](xref:tutorials/publish-to-azure-webapp-using-vs)
